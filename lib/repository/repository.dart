...
class FakeRepository{
  static final List<UserPostModel> postList =[
    UserPostModel(
        name: "jeena",
        profileUrl: "assets/profileImage4.jpg",
    ...
    UserPostModel(
        name: "mirfath",
        profileUrl: "assets/profileImage6.jpg",
    ...
    UserPostModel(
        name: "Mariya",
        profileUrl: "assets/profileImage3.webp",
    ...
    UserPostModel(
        name: "harshi",
        profileUrl: "assets/profileImage2.jpg",
    ...
    UserPostModel(
        name: "riyaa",
        profileUrl: "assets/profileImage1.jpg",
